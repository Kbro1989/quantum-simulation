...
from quantumlab.potentials.barriers import (
    GaussianBarrier, RectangularBarrier, PotentialStep,
    MultipleBarriers, ResonantTunnelingDiode,
    Gaussian2DBarrier, Gaussian3DBarrier,
)
...
POTENTIAL_REGISTRY = {
    'gaussian_barrier':    GaussianBarrier,
    'barrier':             GaussianBarrier,
    'gaussian_2d_barrier': Gaussian2DBarrier,
    'gaussian_3d_barrier': Gaussian3DBarrier,
    'rectangular_barrier': RectangularBarrier,
    'potential_step':      PotentialStep,
    'multiple_barriers':   MultipleBarriers,
    'rtd':                 ResonantTunnelingDiode,
    'infinite_well':       InfiniteSquareWell,
    'finite_well':         FiniteSquareWell,
...
__all__ = [
    ...
    'MultipleBarriers', 'ResonantTunnelingDiode',
    'Gaussian2DBarrier', 'Gaussian3DBarrier',
    'InfiniteSquareWell', 'FiniteSquareWell', 'DoubleWell',
    'HarmonicOscillator', 'CrystalPotential', 'RandomDisorder',
    'CustomPotential', 'create_potential',
]
